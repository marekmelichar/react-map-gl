declare global {
  interface Window {
    TILES_URL: string;
    MAP_BOUNDARY: Array<number>;
  }
}

const TILES_URL = window.TILES_URL;
const MAP_BOUNDARY = window.MAP_BOUNDARY;

const tiles_url = `${TILES_URL}/data/slovak-republic-vector/{z}/{x}/{y}.pbf`;
const glyphs_url = `${TILES_URL}/fonts/{fontstack}/{range}.pbf`;

export const RT_LIGHT_STYLE = {
  "version": 8,
  "name": "Robotrain Light",
  "metadata": {
  ...
  "layers": [
    ...
    {
      "id": "railway_minor_dashline_light",
      "type": "line",
      "metadata": {
        "mapbox:group": "b6371a3f2f5a9932464fa3867530a2e5"
      },
